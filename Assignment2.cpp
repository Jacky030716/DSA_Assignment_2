...
class List{
    ...
    public:
        ...
        void findRoomWithID(int id){
            ...
            if(currIndex){
                cout << "The room ID: " << id << " is found at index " << currIndex << "." << endl;
            }
            else{
        ...
        void findRoomWithIndex(int p){
            hostelNode *temp = head;
            int currIndex = 1;

            while(temp->next != NULL && p != currIndex){
                temp = temp->next;
            }

            if(currIndex){
                cout << "The room ID found at index " << currIndex << " is " << temp->getroomNum() << endl;
            }
            else{
                cout << "No room is found." << endl;
            }
        }
...
void displaySearchingMenu(){
    cout << "\nPlease choose your choice" << endl;
    cout << "1. Search using room ID" << endl;
    cout << "2. Search using index" << endl;
    cout << "Your choice: ";
}
...
int main(){
    ...
    do{
        ...
        switch(choice){
            ...
            case 3:
                int tempRoom, indexNum, searchChoice;
                ...
                do{
                    ...
                    if(searchChoice == 1){
                        cout << "Enter the room ID that you want to search: ";
                        cin >> tempRoom;
                        hostelList.findRoomWithID(tempRoom);
                    }

                    else if(searchChoice == 2){
                        cout << "Enter the index that you want to search: ";
                        cin >> indexNum;
                        hostelList.findRoomWithIndex(indexNum);
                    }
